...
source_table = "03_sellout_filtered_place_id"
...
def get_fn_flowbase():
    ...
    df_prepped = (
        src.selectExpr(
            "customer_name          as business_partner_name",
            "customer_country       as business_partner_country",
            "customer_postal_code   as business_partner_postal_code",
            "customer_address       as business_partner_address",
            "customer_city          as business_partner_city",
            "payload_string",
            "payload",
            "api_name",
            "api_url",
