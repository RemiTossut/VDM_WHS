...
target_table ="Ilis_5526147_V0_metadata"

# --- CONFIG ---
landing_root = "/Volumes/d_dnst_000_landing/volumes/sellout_data/5526147___Ilis___V0/"
sharepoint_folder = "Collection sell-out data/5526147 - Ilis - V0"

config = {
    "file_pattern": "*.xlsx",           # Only Excel files
    "folder_name_skip": ['Old'],        # Skip these folders
    "sheet_name": ["Feuil1", "2025 - S1"],                 # If set, only this sheet is processed
