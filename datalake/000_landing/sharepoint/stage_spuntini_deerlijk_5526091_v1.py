...
target_table ="Spuntini_Deerlijk_5526091_V1_metadata"

# --- CONFIG ---
landing_root = "/Volumes/d_dnst_000_landing/volumes/sellout_data/5526091___Spuntini_Deerlijk___V1/"
sharepoint_folder = "Collection sell-out data/5526091 - Spuntini Deerlijk - V1"

config = {
    "file_pattern": "*.xlsx",           # Only Excel files
    "folder_name_skip": [],        # Skip these folders
    "sheet_name": [],                 # If set, only this sheet is processed
    "sheet_name_skip": ["Sheet1", "Source Identification"],      # Skip these sheets when processing all sheets
}
