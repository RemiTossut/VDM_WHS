...
target_table ="Spuntini_Free_Foods_5525973_V0_metadata"

# --- CONFIG ---
landing_root = "/Volumes/d_dnst_000_landing/volumes/sellout_data/5525973___Spuntini_Free_Foods___V0/"
sharepoint_folder = "Collection sell-out data/5525973 - Spuntini Free Foods - V0"

config = {
    "file_pattern": "*.xlsx",           # Only Excel files
    "folder_name_skip": [],        # Skip these folders
    "sheet_name": [],                 # If set, only this sheet is processed
    "sheet_name_skip": ["Draaitabel"],      # Skip these sheets when processing all sheets
}
