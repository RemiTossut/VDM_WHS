...
target_table ="Van_Zon_5526010_V0_metadata"

# --- CONFIG ---
landing_root = "/Volumes/d_dnst_000_landing/volumes/sellout_data/5526010___Van_Zon___V0/"
sharepoint_folder = "Collection sell-out data/5526010 - Van Zon - V0"

config = {
    "file_pattern": "*.xlsx",           # Only Excel files
    "folder_name_skip": [],        # Skip these folders
    "sheet_name": ["Rapport"],                 # If set, only this sheet is processed
    "sheet_name_skip": ["Tabel"],      # Skip these sheets when processing all sheets
}
