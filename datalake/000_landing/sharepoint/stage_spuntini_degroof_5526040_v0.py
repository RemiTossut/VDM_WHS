...
target_table ="Spuntini_Degroof_5526040_V0_metadata"

# --- CONFIG ---
landing_root = "/Volumes/d_dnst_000_landing/volumes/sellout_data/5526040___Spuntini_Degroof___V0/"
sharepoint_folder = "Collection sell-out data/5526040 - Spuntini Degroof - V0"

config = {
    "file_pattern": "*.xlsx",           # Only Excel files
    "folder_name_skip": [],        # Skip these folders
    "sheet_name": [],                 # If set, only this sheet is processed
    "sheet_name_skip": ["Sheet1"],      # Skip these sheets when processing all sheets
}
