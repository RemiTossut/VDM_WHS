...
target_table ="Spuntini_Deerlijk_5526091_V0_metadata"

# --- CONFIG ---
landing_root = "/Volumes/d_dnst_000_landing/volumes/sellout_data/5526091___Spuntini_Deerlijk___V0/"
sharepoint_folder = "Collection sell-out data/5526091 - Spuntini Deerlijk - V0"

config = {
    "file_pattern": "*.xlsx",           # Only Excel files
    "folder_name_skip": ["2023", "OLD"],        # Skip these folders
