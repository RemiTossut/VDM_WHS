...
target_table ="Makady_5525924_V0_metadata"

# --- CONFIG ---
landing_root = "/Volumes/d_dnst_000_landing/volumes/sellout_data/5525924___Makady___V0/"
sharepoint_folder = "Collection sell-out data/5525924 - Makady - V0"

config = {
    "file_pattern": "*.xlsx",           # Only Excel files
    "folder_name_skip": ["OLD"],        # Skip these folders
    "sheet_name": [],                 # If set, only this sheet is processed
    "sheet_name_skip": ['UoM correct', 'UoM V2', 'UoM'],      # Skip these sheets when processing all sheets
}
